...
function tmm_dashboard_widgets() {
	...
	add_meta_box('tmm_support_dashboard_widget', 'Need Help?', 'tmm_support_dashboard_widget_function', 'dashboard', 'side', 'high');
	add_meta_box('dashboard_custom_feed', 'Updates from The Mighty Mo!', 'tmm_dashboard_custom_feed_output', 'dashboard', 'side', 'high');
